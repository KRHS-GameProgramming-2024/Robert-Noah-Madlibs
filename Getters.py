...
def getWord(prompt, debug = False):
    ...
    while not goodInput:
        ...
        if word =="":
            ...
            goodInput = False
            momma = input("Do you kiss your mother with that mouth? ")
            if "yours" in momma.lower():
                print(" \n \nget yo own Alabama lookin momma into your own \ntrailer park and kiss her instead")
                quit()
    return word
...
def friendsHouseFunction(debug):
    ...
    while not goodHouse:
        friendsHouse = input("Which friend's house do they go to? > ")
